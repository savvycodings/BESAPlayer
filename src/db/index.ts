...
export const marketSets = dbSchema.marketSets
export const marketCards = dbSchema.marketCards
export const priceSyncJobs = dbSchema.priceSyncJobs
export const priceSyncFailures = dbSchema.priceSyncFailures
